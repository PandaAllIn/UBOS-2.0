...
import { OradeaBusinessAgent } from '../agents/premium/oradeaBusinessAgent.js';

async function main() {
  const agent = new OradeaBusinessAgent('oradea-cli', 'oradea-business');
  ...
  switch (cmd) {
    ...
    case 'meeting:schedule': {
      ...
      try {
        ...
        console.log(`❌ Failed to schedule meeting: ${message}`);
      }
      break;
    }
