...
const agentSummonerAgentFeature: AgentFeature = {
  type: 'agent-summoner-advanced',
  capabilities: ['agent-discovery', 'analysis', 'recommendation'],
  requirements: { tools: ['perplexity', 'filesystem'] }
};

export class AgentSummonerAgent extends BaseAgent {
  constructor(id: string, requirementId: string = 'agent-summoner') {
    super(id, requirementId, agentSummonerAgentFeature);
  }
