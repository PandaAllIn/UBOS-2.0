import { BaseAgent, type AgentRunOptions, type AgentContext, type AgentFeature } from './baseAgent.js';
 ...
 */
const coordinationFeature: AgentFeature = {
  type: 'coordination',
  capabilities: ['multi-agent-coordination', 'task-routing', 'result-aggregation'],
  requirements: { minimumAgents: 1 }
};

export class CoordinationAgent extends BaseAgent {
  constructor(id: string, requirementId: string = 'agent-coordination') {
    super(id, requirementId, coordinationFeature);
  }
