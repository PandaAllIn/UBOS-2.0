...
// Context7-guided: EU Funding Proposal agent feature definition
const eufmProposalFeature: AgentFeature = {
  type: 'eu-funding-proposal',
  capabilities: ['proposal-generation', 'template-creation', 'analysis-integration'],
  requirements: { programmes: ['horizon-europe', 'life', 'cef'] }
};
...
export class EUFundingProposalAgent extends BaseAgent {
  constructor(id: string, requirementId: string = 'eu-funding-proposal-agent') {
    super(id, requirementId, eufmProposalFeature);
  }
  ...
  async run(opts: AgentRunOptions): Promise<AgentResult> {
    ...
    try {
      ...
      // Simplify: Generate template directly without AgentSummoner integration for now
      const advisoryNote = 'Template generated with standard EU funding structure';
      const analyzedDomain = 'EU Research & Innovation';
